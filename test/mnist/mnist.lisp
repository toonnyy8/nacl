...
(defvar test-xs (numcl:asarray (numpy-file-format:load-array "/root/git/nacl/test/mnist/data/mnist_test_x.npy")))
(setf test-xs (numcl:reshape test-xs `(-1 ,(* 28 28))))
(numcl:shape test-xs)
(defvar test-ys (numcl:asarray (numpy-file-format:load-array "/root/git/nacl/test/mnist/data/mnist_test_y.npy")))
